...
This is a copy from Airbnb's Ruby Style Guide with modifications. We cribbed
it at [this commit](6e4c2cf7eb7319b4d8f203d9c3839d839c46313://github.com/airbnb/ruby/tree/6e4c2cf7eb7319b4d8f203d9c3839d839c46313d)
...
* <a name="default-indentation"></a>Use soft-tabs with a two
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L679-L682)]</sup>

* <a name="indent-when-as-case"></a>Indent `when` as deep as `case`.
    <sup>[[link](#indent-when-as-case)]</sup><sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L466-L469)]</sup>
...
* <a name="align-function-params"></a>Align function parameters either all on
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L398-L403)]</sup>
...
* <a name="indent-multi-line-bool"></a>Indent succeeding lines in multi-line
    boolean expressions.<sup>[[link](#indent-multi-line-bool)]</sup><sup>
    [[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L756-L760)]</sup>
...
* <a name="trailing-whitespace"></a>Never leave trailing whitespace.
    <sup>[[link](#trailing-whitespace)]</sup><sup>[[rubocop](
    https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1093-L1096)]</sup>
...
* <a name="space-before-comments"></a>When making inline comments, include a
    ...
    <sup>[[link](#space-before-comments)]</sup><sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L984-L989)]</sup>
...
* <a name="spaces-operators"></a>Use spaces around operators; after commas,
    ...
    <sup>[[link](#spaces-operators)]</sup><sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1014-L10172)]</sup>
...
* <a name="no-space-before-commas"></a>Never include a space before a comma.
    <sup>[[link](#no-space-before-commas)]</sup><sup>[[rubocop](
    https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L981-L983
    )]</sup>
...
* <a name="spaces-block-params"></a>Do not include space inside block
    ...
    <sup>[[link](#spaces-block-params")]</sup><sup>[[rubocop](
    https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1001-L1004
    )]</sup>
...
* <a name="no-space-after-!"></a>Do not leave space between `!` and its
    argument.<sup>[[link](#no-space-after-!)]</sup><sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L965-L968)]</sup>
...
* <a name="no-spaces-braces"></a>No spaces after `(`, `[` or before `]`, `)`.
    <sup>[[link](#no-spaces-braces)]</sup><sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1029-L1032)]</sup>
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1019-L1022)]</sup>
...
* <a name="no-spaces-string-interpolation"></a>Omit whitespace when doing
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1039-L1042)]</sup>
...
* <a name="no-spaces-range-literals"></a>Don't use extra whitespace in range
    literals.<sup>[[link](#no-spaces-range-literals)]</sup><sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1034-L1037)]</sup>
...
* <a name="newline-after-conditional"></a>Add a new line after conditionals,
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L747-L749)]</sup>
...
* <a name="newline-between-methods"></a>Include one, but no more than one, new
    line between methods.<sup>[[link](#newline-between-methods)]</sup><sup>
    [[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L563-L566)]</sup>
...
<a name="no-block-comments"></a>Related: do not use block comments. They cannot
  ...
  <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L440-L443)]</sup>
...
* <a name="method-def-parens"></a>Use `def` with parentheses when there are
    ...
    parameters.<sup>[[link](#method-def-parens)]</sup><sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L527-L530)]</sup>
...
* <a name="no-single-line-methods"></a>Avoid single-line methods. Although
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L933-L936)]</sup>
...
* <a name="returns-val-parens"></a>If the method returns a value.
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L527-L530)]</sup>
...
* <a name="space-method-call"></a>Never put a space between a method name and
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L128-L133)]</sup>
...
* <a name="no-args-parens"></a>**Omit parentheses** for a method call if the
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L720-L723)]</sup>
...
* <a name="multiline-if-then"></a>Never use `then` for multi-line `if/unless`.
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L751-L754)]</sup>
...
* <a name="multiline-while-until"></a>Never use `do` for multi-line `while` or
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1142-L1145)]</sup>
...
* <a name="no-and-or"></a>The `and`, `or`, and `not` keywords are banned. It's
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L405-L408)]</sup>
...
* <a name="no-unless-with-else"></a>Never use `unless` with `else`. Rewrite
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#1103-L1108)]</sup>
...
* <a name="parens-around-conditions"></a>Don't use parentheses around the
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L841-L846)]</sup>
...
* <a name="no-nested-ternaries"></a>Use one expression per branch in a ternary
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L781-L784)]</sup>
...
* <a name="no-multiline-ternaries"></a>Avoid multi-line `?:` (the ternary
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L762-L767)]</sup>
...
* <a name="no-for"></a>Never use `for`, unless you know exactly why. Most of the
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L635-L638)]</sup>
...
* <a name="self-assignment"></a>Use shorthand self assignment operators
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L911-L916)]</sup>
...
* <a name="semicolons"></a>Avoid semicolons except for in single line class
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L918-L921)]</sup>
...
* <a name="colon-use"></a>Use :: only to reference constants(this includes
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L503-L506)]</sup>
...
* <a name="redundant-return"></a>Avoid `return` where not required.
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L887-L890)]</sup>
...
* <a name="assignment-in-conditionals"></a>Don't use the return value of `=` in
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L20-L23)]</sup>
...
* <a name="lambda-calls"></a>Use `.call` explicitly when calling lambdas.
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L704-L707)]</sup>
...
* <a name="no-cryptic-perl"></a>Avoid using Perl-style special variables (like
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1044-L1047)]</sup>
...
* <a name="single-action-blocks"></a>When a method block takes only one
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L449-L455)]</sup>
...
* <a name="redundant-self"></a>Prefer `some_method` over `self.some_method` when
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L892-L895)]</sup>
...
* <a name="snake-case"></a>Use `snake_case` for methods and variables.
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#732-L735)]</sup>

* <a name="camel-case"></a>Use `CamelCase` for classes and modules. (Keep
    acronyms like HTTP, RFC, XML uppercase.)
    <sup>[[link](#camel-case)]</sup>
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L476-L479)]</sup>

* <a name="screaming-snake-case"></a>Use `SCREAMING_SNAKE_CASE` for other
    constants.<sup>[[link](#screaming-snake-case)]</sup>
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L522-L525)]</sup>
...
* <a name="bang-methods"></a>The names of potentially "dangerous" methods
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L801-L804)]</sup>
...
* <a name="avoid-class-variables"></a>Avoid the usage of class (`@@`) variables
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L494-L497)]</sup>
...
* <a name="access-modifiers"></a>Indent the `public`, `protected`, and
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L572-L574)]</sup>
...
* <a name="dont-rescue-exception"></a>Avoid rescuing the `Exception` class.
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L141-L144)]</sup>
...
* <a name="redundant-exception"></a>Don't specify `RuntimeError` explicitly in
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L882-L884)]</sup>
...
* <a name="exception-class-messages"></a>
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L872-L875)]</sup>
...
* <a name="rescue-as-modifier"></a>Avoid using rescue in its modifier form.
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L906-L909)]</sup>
...
* <a name="detect-over-find"></a>Prefer `detect` over `find`. The use of `find`
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L270-L275)]</sup>
...
* <a name="size-over-count"></a>Prefer `size` over either `length` or `count`
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L302-L307)]</sup>
...
* <a name="empty-collection-literals"></a>Prefer literal array and hash creation
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L592-L595)]</sup>
...
* <a name="array-join"></a>Favor `Array#join` over `Array#*` for clarity.
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L410-L413)]</sup>
...
* <a name="symbol-literals"></a>Relatedly, use plain symbols instead of string
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1065-L1067)]</sup>
...
* <a name="deprecated-hash-methods"></a>Use `Hash#key?` instead of
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L532-L535)]</sup>
...
* <a name="array-trailing-comma"></a>Use a trailing comma in an `Array` that
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1088-L1091)]</sup>
...
* <a name="multi-line-strings"></a>Use `\` at the end of the line instead of `+`
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L714-L718)]</sup>
...
* <a name="percent-literal-delimiters"></a>Prefer parentheses over curly
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L435-L438)]</sup>
...
* <a name="percent-w"></a>Use `%w` freely.<sup>[[link](#percent-w)]</sup>
  <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L1154-L1157)]</sup>
...
* <a name="percent-r"></a>Use `%r` only for regular expressions matching *more
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L897-L900)]</sup>
...
* <a name="percent-x"></a>Avoid the use of %x unless you're going to invoke a
    ...
    <sup>[[rubocop](https://github.com/ForwardFinancing/code_styles/blob/master/rubocop.yml#L508-L511)]</sup>
